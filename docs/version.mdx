...
| ------------- | -------------------------- | ------------ | ------------- | -------------- | ------------------------------------------------------ |
| RocketCore    | Core services for Rocket   | v0.6.0-alpha | Unstable      | No             | -                                                      |
| RocketAPI     | Backend APIs for Rocket    | v0.6.0-alpha | Unstable      | No             | -                                                      |
| RocketWeb     | Web Application for Rocket | v0.6.1-alpha | Unstable      | No             | -                                                      |
| RocketLanding | Landing Page for Rocket    | v0.9.10-rc   | Stable        | No             | -                                                      |
| RocketDocs    | Documentation for Rocket   | v0.1.7-alpha | Unstable      | Yes            | https://github.com/rocket-org-imdeepmind/RocketDocs    |
